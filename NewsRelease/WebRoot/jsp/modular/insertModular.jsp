  ...
  <div id="update-body">
    <div class="main_left">
      ...
      <div class="main_left_bottom">
        ...
        <form action="modular/insertModular" method="post">
          ...
          <table class="table" style="text-align: right;">
            ...
            <tr>
              <th><span class="txta">*</span> 默认值：</th>
            ...
            <tr>
              ...
              <input type="submit" value="提交" class="bind_btn" id="submit_btn" />
               <a href="modular/modularList/>" class="bbtn"><cite>取消</cite> </a>
              </td>
            </tr>
          </table>
        </form>

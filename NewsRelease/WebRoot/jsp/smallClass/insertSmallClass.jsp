  ...
  <div id="update-body">
    <div class="main_left">
      ...
      <div class="main_left_bottom">
        ...
        <form action="smallClass/insertSmallClass" method="post">
          ...
          <table class="table" style="text-align: right;">
            ...
            <tr>
              <td colspan="3" align="right"><input type="submit" value="提交" class="bind_btn" id="submit_btn" /> <a href="smallClass/smallClassList/>" class="bbtn"><cite>取消</cite> </a>
              </td>
            </tr>
          </table>
        </form>

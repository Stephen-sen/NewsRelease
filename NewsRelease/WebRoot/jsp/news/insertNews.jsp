  ...
  <div id="insertNews-body">
    <div class="main_left">
      ...
      <div class="main_left_bottom">
        ...
        <form id="form1" action="news/insertNews" method="post">
          ...
          <table class="table" style="text-align: right;">
            ...
            <tr>
              <th><span class="txta">*</span>内容：</th>
              <td><input type="hidden" name="news.content" id="content1"></td>
            </tr>

            <tr>
              <td colspan="2"><textarea id="content2" name="content" style="width:800px;height:200px;"></textarea></td>
            </tr>
